...
namespace AppCurso {
    public class CentralDeExercicios {
        ...
        public void SelecionarEExecutar() {
            ...
            Console.Write(nomeDoExercicio);  // Use Console.Write para não adicionar quebra de linha aqui
            Console.ResetColor();
            Console.WriteLine();  // Agora sim quebra a linha após o texto colorido
            // Agora desenha a linha de igualdades apenas com base no comprimento do nomeDoExercicio
            
            int totalLength = nomeDoExercicio.Length + 21;
